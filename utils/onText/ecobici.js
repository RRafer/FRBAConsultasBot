...
exports.execute = (bot, msg, match) => {
	request({
		...
		if(!e && response.statusCode === 200){
			...
			if(!GetStation){
				bot.sendMessage(msg.chat.id, 'Inserte un ID de estación valido', {reply_to_message_id: msg.message_id});
				return;
			}
